...
const countries = {
  features: [] // Add your actual country features here
};
...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  const groupRef = useRef<Group>(null); // Fixed: Added proper typing
...
export function WebGLRendererConfig() {
  ...
  }, [gl, size.width, size.height]); // Fixed: Added dependencies
